                ...
                <form id="quiz-form" action="includes/quiz-helper.php" method="post">
                    ...
                    <div class="question bg-white p-3 border-bottom">
                        ...
                        <div class="ans ml-2">
                            ...
                            <input type="text" name="t1" id="t1" placeholder="Tag 1" align='right'>
                        </div>
                        <div class="ans ml-2">
                            <input type="text" name="a2" id="a2" placeholder="Answer 2">
                            <input type="text" name="t2" id="t2" placeholder="Tag 2" align='right'>
                        </div>
                        <div class="ans ml-2">
                            <input type="text" name="a3" id="a3" placeholder="Answer 3">
                            <input type="text" name="t3" id="t3" placeholder="Tag 3" align='right'>
                        </div>
                        <div class="ans ml-2">
                            <input type="text" name="a4" id="a4" placeholder="Answer 4">
                            <input type="text" name="t4" id="t4" placeholder="Tag 4" align='right'>
                        </div>

                    </div>
                    <div class="form-group">
                        <button class="btn btn-outline-danger" type="submit" name="ques-submit" id="ques-submit"
                            style="width: 30%">Submit Question</button>
