<?php
// Right now you have to go into the database and manually update the category section, to get new games to show...will fix later
// Also may need to change some of the games categorys to match better; plan to do later
