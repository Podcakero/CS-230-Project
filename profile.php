            ...
            <div class="h-50 center-me text-center">
                <div class="my-auto">
                    <form action="includes/upload-helper.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <button type="submit" name="prof-submit" class="btn btn-success btn-lg btn-block center"
                                style="width:50%;">
                                Update
                            </button>
                        </div>
                    ...
                    <div class="" style="padding:5px;">
                        <div class="column" style="float:left;">
                            ...
                            <div class="center-me "><h3><b>'.$gameTitle.'</h3></b></div>
                                <img src="'.$gamePic.'" alt="" class="center" style="height:70%;"> 
...
?>
            ...
            <a href="myreviews.php" class="btn btn-danger btn-lg active center" style="margin-top:5px;width:25%;"
