...
if ($_logged_in) {
    ...
    //Get profile pic
    $sql = "SELECT profpic FROM profiles WHERE uid = ?";
    $stmt = $conn->prepare($sql);
    $stmt->execute(array($_SESSION['uid']));
...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
        ...
        <a class="navbar-brand" href="../index.php" style="color:mistyrose;">WIP</a>
                ...
                echo 
                    ...
                    if (isset($_SESSION['uid'])) {
                        echo 
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="suggestions.php" style="color:mistyrose;font-size: large;">Suggestions</a>
                            </li>
                            <li class="nav-item">
                        ...
                        if ($_admin == 1) {//Is admin
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="../Addq.php">Create New Quiz<i class="fas fa-plus-circle" style="margin-left:4px;"></i></a>
                                    <a class="dropdown-item" href="#">Edit Quiz<i class="fas fa-edit"  style="margin-left:4px;"></i></a>
                                    <a class="dropdown-item" href="../admin.php">Edit Gallery<i class="fas fa-edit"  style="margin-left:4px;"></i></a>
                                    <div class="dropdown-divider">
                                    </div>
                                    <a class="dropdown-item" href="#">Other Admin Stuff</a>
                                </div>
                            </li>
                            ';
                        }
