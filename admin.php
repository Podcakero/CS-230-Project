...
<?php
if(isset($_SESSION['uid']) & $_admin == true){
        ...
        <div class="my-auto">
            ...
            <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <img src="images/collage.jpg" alt="gallery pic" onclick="triggered();" id="gallery-display">
                ...
                <div class="form-group">
                    <button type="submit" name="gallery-submit" class="btn btn-outline-success btn-lg">upload</button>
                </div>
